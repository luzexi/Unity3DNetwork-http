...
namespace MsgPack
{
	public class CustomPacker
	{
        ...
        delegate void PackDelegate (CustomPacker packer, MsgPackWriter writer, object o);
		delegate object UnpackDelegate (CustomPacker packer, MsgPackReader reader);
	...
	public class NonPack : Attribute{}
}
